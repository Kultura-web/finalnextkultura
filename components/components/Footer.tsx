          ...
          <div>
            ...
            <div className="flex gap-4">
              {footer.instagram_url && (
                <a href={footer.instagram_url} target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-[#c8aa57] transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
              )}
              {footer.facebook_url && (
                <a href={footer.facebook_url} target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-[#c8aa57] transition-colors">
